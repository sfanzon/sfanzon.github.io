...
Announced that an extension of $\mathbb{Q}$ is possible, and is called $\mathbb{R}$, the set of real numbers  |
|    2              |  28 Sep       |    Preliminaries: Sets, Basic Logic, Operations on Sets, Binary relations, Equivalence relation with examples                                                                                                                                       |
|    3              |  5 Oct          |    Partial Order relation. Total order. Intervals. Functions with examples. Definition of absolute value and its geometric meaning. Proved basic lemma on absolute value.                                        |
|    4              |  5 Oct          |    Triangle inequality with proof. Geometric meaning of triangle inequality. Proofs in Mathematics. Simple example of a proof involving a small quantity $\varepsilon$                                              |
|    5              |  12 Oct        |                             																		                                                                                                                                   |
|    6              |  12 Oct        |   																					                                                                                                                                   |
|    7              |  19 Oct        |    																					                                                                                                                                   |
|    8              |  19 Oct        |  																					                                                                                                                                   |
